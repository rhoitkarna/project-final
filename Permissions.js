  ...
  try {
    ...
    if (response === RESULTS.GRANTED) {
      ...
      if (result === RESULTS.GRANTED) {
        ...
        if (withAlert) {
          showAlert(
            'Permission not granted for camera. You will not be able to use the camera in this application.',
          );
        }
        return false;
      }
  ...
  try {
    ...
    if (response === RESULTS.GRANTED) {
      ...
      if (result === RESULTS.GRANTED) {
        ...
        if (withAlert) {
          showAlert(
            'Permission not granted for photos. You will not be able to get photos in this application.',
          );
        }
        return false;
      }
